...
class OrderDepth:
    """
    la profondità dell'ordine (o order book depth) rappresenta la lista degli ordini attivi e non ancora eseguiti
    presenti nel mercato per comprare/vendere un determinato asset
    """
